        ...
        <div className="p-6 sm:p-8 overflow-y-auto space-y-6 text-sm text-slate-300 leading-relaxed">
          ...
          {activeTab === 'privacy' && (
            <div className="space-y-6">
              ...
              <section className="space-y-2">
                ...
                <p>
                  Surprise websites remain active perpetually unless you request deletion. You can request complete removal of your published links and media assets at any time by contacting our privacy officer at <a href="mailto:codelearnpoint@gmail.com" className="text-rose-400 underline">codelearnpoint@gmail.com</a>.
                </p>
              </section>
            </div>
          )}
          ...
          {activeTab === 'about' && (
            <div className="space-y-6">
              ...
              {/* SEO Authority & Google Ranking Overview */}
              <div className="p-5 bg-slate-950/80 border border-slate-800 rounded-2xl space-y-3 text-xs text-slate-300">
                <h4 className="font-bold text-white text-sm flex items-center space-x-2">
                  <Award className="w-4 h-4 text-rose-400" />
                  <span>How to Rank #1 on Google for "Online Wishes"</span>
                </h4>
                <p className="text-slate-400 leading-relaxed">
                  To ensure <strong>OnlineWishes</strong> dominates Google search results for queries like <span className="text-rose-400 font-mono">"online wishes"</span>, <span className="text-rose-400 font-mono">"online wishes devang varshney"</span>, and <span className="text-rose-400 font-mono">"digital surprise website"</span>, the platform incorporates advanced SEO best practices:
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                  <div className="p-3 bg-slate-900/60 rounded-xl border border-slate-800/80 space-y-1">
                    <span className="font-bold text-white block">1. Keyword Optimization & Title Tags</span>
                    <p className="text-[11px] text-slate-400">Strategic placement of primary keywords ("Online Wishes", "OnlineWishes.in", developer "Devang Varshney") across meta titles, H1/H2 tags, and schema JSON-LD data.</p>
                  </div>
                  <div className="p-3 bg-slate-900/60 rounded-xl border border-slate-800/80 space-y-1">
                    <span className="font-bold text-white block">2. High-Quality Backlinks & Social Sharing</span>
                    <p className="text-[11px] text-slate-400">Every shared surprise link generated by users creates organic backlinks and social proof across Instagram, WhatsApp, and Facebook.</p>
                  </div>
                  <div className="p-3 bg-slate-900/60 rounded-xl border border-slate-800/80 space-y-1">
                    <span className="font-bold text-white block">3. Lightning-Fast Core Web Vitals</span>
                    <p className="text-[11px] text-slate-400">Built on optimized Vite + React architecture ensuring 99+ PageSpeed scores, fast crawling, and instant mobile responsiveness.</p>
                  </div>
                  <div className="p-3 bg-slate-900/60 rounded-xl border border-slate-800/80 space-y-1">
                    <span className="font-bold text-white block">4. Structured Schema Markup</span>
                    <p className="text-[11px] text-slate-400">Rich snippet JSON-LD metadata for WebSite, Organization, and SoftwareApplication guarantees prominent Google Knowledge Graph placement.</p>
                  </div>
                </div>
              </div>
