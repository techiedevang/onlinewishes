            ...
            <div className="space-y-6">
              ...
              <div className="p-5 bg-slate-950/80 border border-slate-800 rounded-2xl space-y-3 text-xs text-slate-300">
                <h4 className="font-bold text-white text-sm flex items-center space-x-2">
                  ...
                  <span>Our Mission at OnlineWishes</span>
                </h4>
                <p className="text-slate-400 leading-relaxed">
                  <strong>OnlineWishes</strong> was created to redefine how we celebrate special occasions in the digital age. Developed by <strong>Devang Varshney</strong>, the platform is designed with a single goal: to help people easily craft highly personalized, interactive, and emotionally resonant digital surprises for their loved ones.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                  <div className="p-3 bg-slate-900/60 rounded-xl border border-slate-800/80 space-y-1">
                    <span className="font-bold text-white block">A Vision by Devang Varshney</span>
                    <p className="text-[11px] text-slate-400">Combining beautiful design with seamless technology to bring smiles to faces worldwide.</p>
                  </div>
                  <div className="p-3 bg-slate-900/60 rounded-xl border border-slate-800/80 space-y-1">
                    <span className="font-bold text-white block">Unforgettable Memories</span>
                    <p className="text-[11px] text-slate-400">Every template is thoughtfully crafted to turn everyday moments into lifelong memories.</p>
                  </div>
                  <div className="p-3 bg-slate-900/60 rounded-xl border border-slate-800/80 space-y-1">
                    <span className="font-bold text-white block">Secure & Private</span>
                    <p className="text-[11px] text-slate-400">End-to-end passcode protection ensuring that your personal messages remain only for the intended recipient.</p>
                  </div>
                  <div className="p-3 bg-slate-900/60 rounded-xl border border-slate-800/80 space-y-1">
                    <span className="font-bold text-white block">Accessible to Everyone</span>
                    <p className="text-[11px] text-slate-400">No coding skills required. Creating a beautiful digital surprise is as simple as filling out a form.</p>
                  </div>
                </div>
              </div>
